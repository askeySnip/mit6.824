...
func sendHearBeat(rf *Raft) {
	args := RequestAppendEntriesArgs{Term: rf.currentTerm, LeaderId: rf.me, PrevLogIndex: len(rf.log) - 1,
	...
	for i := range rf.peers {
		...
		//DPrintf("%v sending heartbeat to %v", rf.me, i)
		waitGroup.Add(1)
